...
from Autodesk.Revit.DB import ElementId, Level, ViewPlan, FilledRegion, BuiltInParameter, FilteredElementCollector
...
def start():
    ...
    if type(elements) is list:
       for elem in elements:
           work_plane_param = elem.get_Parameter(BuiltInParameter.FAMILY_WORK_PLANE_PARAM)
           print(work_plane_param)
