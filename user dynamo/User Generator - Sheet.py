...
def start():
    ...
    for target_view in views:
        ...
        # continue
        # if target_view.Name != "UNIT 0212 BPR-2AR-RI":
        #     continue
        ...
        # if unit.level not in [2, 4,5,6,7,8]: continue
        ...
        new_sheet.SheetCollectionId = sheet_collection[TOWER]
        ...
        if "OFFICE" not in target_view.Name and "B209":
            panel_schedule = panel_dict[f"{TOWER}{unit.unit_no}"]
